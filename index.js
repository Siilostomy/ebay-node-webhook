...
const ENDPOINT_URL = 'https://ebay-node-webhook.onrender.com'; // ✅ no trailing slash

// Middleware for JSON and plain text
...
// Handle POST (eBay JSON notifications or Zapier token check)
app.post('/', (req, res) => {
